...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        DockWidget.setTabOrder(self.value_Dz, self.metrics_line)
        DockWidget.setTabOrder(self.metrics_line, self.result_line)
        DockWidget.setTabOrder(self.result_line, self.angle_line_1)
        DockWidget.setTabOrder(self.angle_line_1, self.pushButton_angle)
        DockWidget.setTabOrder(self.pushButton_angle, self.result_line_angle)
        DockWidget.setTabOrder(self.result_line_angle, self.pushButton)
